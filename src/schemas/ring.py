...
class Ring(BaseModel):
    ...
    size: Annotated[
        float,
        Field(ge=4, le=13, multiple_of=0.5, description="Size from 4 to 13 with step of 0.5")
    ]
    ring_width: Annotated[
        float,
        Field(ge=1, le=8, multiple_of=0.5, description="Ring width from 1mm to 8mm with step of 0.5mm")
    ]
    engraving: Annotated[
        Optional[str],
